...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your complete digital companion for organizing and managing dansala events." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Dansala Event Manager" },
      { property: "og:description", content: "Your complete digital companion for organizing and managing dansala events." },
